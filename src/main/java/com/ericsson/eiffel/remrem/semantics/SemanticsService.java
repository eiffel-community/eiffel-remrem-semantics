...
public class SemanticsService implements MsgService{
    ...
    private void outputValidate(EiffelEventType eiffelType, String jsonStringInput) throws EiffelValidationException {
        ...
        linksValidation(eiffelType, jsonObject);
    }
            ...
            if (links.size() != 0) {
                ...
                if(requiredLinks != null) {
                    for (String requiredLink : requiredLinks) {
                        ...
                        } else if(count > 1 && !Links.valueOf(requiredLink).isMultipleAllowed()) {
                ...
                for (String optionalLink : optionalLinks) {
                    ...
                    if(count != null && (count > 1 && !Links.valueOf(optionalLink).isMultipleAllowed())) {
