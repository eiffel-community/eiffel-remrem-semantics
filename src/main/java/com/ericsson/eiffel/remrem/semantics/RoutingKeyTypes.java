...
public enum RoutingKeyTypes {    
    ...
    EiffelAnnouncementPublishedEvent("info","announcement"),
    ...
    EiffelConfigurationAppliedEvent("configuration","applied"),
    EiffelEnvironmentDefinedEvent(EiffelConstants.CM,"environment"),
    EiffelFlowContextDefinedEvent("flowcontext","defined"),
