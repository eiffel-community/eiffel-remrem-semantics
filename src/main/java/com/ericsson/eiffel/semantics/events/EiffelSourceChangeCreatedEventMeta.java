...
public class EiffelSourceChangeCreatedEventMeta implements Meta
{
    ...
    @Expose
    private EiffelSourceChangeCreatedEventMeta.Version version = EiffelSourceChangeCreatedEventMeta.Version.fromValue("1.0.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        @SerializedName("eiffelsourcechangecreated")
        EIFFELSOURCECHANGECREATED("eiffelsourcechangecreated");
