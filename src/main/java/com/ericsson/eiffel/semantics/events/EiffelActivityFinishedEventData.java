...
public class EiffelActivityFinishedEventData implements Data {
	...
	@Expose
	private EiffelActivityFinishedEventOutcome outcome;
	 ...
	 * 
	 */
	public EiffelActivityFinishedEventOutcome getOutcome() {
		return outcome;
	}
	 ...
	 * 
	 */
	public void setOutcome(EiffelActivityFinishedEventOutcome outcome) {
